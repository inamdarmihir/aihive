...
- [The Problem with Stateless Retrieval](#the-problem-with-stateless-retrieval)
- [Component One: The Cache Hierarchy Model](#component-one-the-cache-hierarchy-model)
  - [L1: The Context Window](#l1-the-context-window)
  - [L2: Qdrant as Semantic Cache](#l2-qdrant-as-semantic-cache)
  - [L3: External Storage and Cold Retrieval](#l3-external-storage-and-cold-retrieval)
- [Component Two: Eviction Policy](#component-two-eviction-policy)
  - [What Makes a Context Segment Evictable](#what-makes-a-context-segment-evictable)
  - [Priority-Weighted LRU](#priority-weighted-lru)
  - [Write-Back vs. Write-Through](#write-back-vs-write-through)
- [Component Three: Prefetching Across Subgraph Boundaries](#component-three-prefetching-across-subgraph-boundaries)
  - [The Boundary Problem](#the-boundary-problem)
  - [Lookahead Prefetch](#lookahead-prefetch)
  - [Invalidation on State Mutation](#invalidation-on-state-mutation)
- [Component Four: The ContextAllocator Node](#component-four-the-contextallocator-node)
  - [State Schema Design](#state-schema-design)
  - [The Allocator Node](#the-allocator-node)
  - [Budget Accounting](#budget-accounting)
- [Component Five: SemanticCache in Qdrant](#component-five-semanticcache-in-qdrant)
  - [Collection Design](#collection-design)
  - [Eviction as a Qdrant Payload Filter](#eviction-as-a-qdrant-payload-filter)
  - [Write-Back on Dirty Segments](#write-back-on-dirty-segments)
