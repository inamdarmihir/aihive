...
Exact hashing is blind to light edits. **SimHash** ([Charikar, 2002](https://dl.acm.org/doi/10.1145/509907.509965)) yields fingerprints with small Hamming distance for similar inputs:
